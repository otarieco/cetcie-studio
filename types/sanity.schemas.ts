...
export enum SANITY_SINGLETONS {
  ...
  $HORSE_BIOGRAPHY = 'horse_biography',
...
export enum SANITY_SECTIONS {
  ...
  // biography
  $HORSE_BIOGRAPHY_LONG_TEXT = 'section.biography_long_text',
  $HORSE_BIOGRAPHY_FULL_SCREEN_IMAGE = 'section.biography_full_screen_image',
